...
class EmbutidosActivity :
    BaseActivity<ActivityEmbutidosBinding>(R.layout.activity_embutidos) {
    ...
    private fun createFragments(){
        ...
        val products: HashMap<String, String> = intent.getSerializableExtra("Embutidos") as HashMap<String, String>
...
//            startActivity(destIntent)
    ...
    companion object {
        ...
        fun getIntent(context: Context, bundle: Bundle?): Intent {
            val destIntent = Intent(context, EmbutidosActivity::class.java)
