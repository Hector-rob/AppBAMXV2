...
class FoodDonations : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btndonar = findViewById<Button>(R.id.btnDonar)

        btndonar.setOnClickListener(View.OnClickListener {
            ...
            if(amount1 != 0 &&
                ...
                Toast.makeText(this, "Por favor seleccione un alimento", Toast.LENGTH_SHORT).show()
            }
